    ...
    <Row className='viperPage d-flex justify-content-center align-items-center text-center'>
      <Col className=' d-flex justify-content-center mt-5 mb-5 '  xs={12}md={5}>
        <div className='divArtist'>
          <img className='fotoProfilo' src="http://res.cloudinary.com/dorr4si5z/image/upload/v1709309395/foa65gsoysmrrqjh7ue8.png" alt="" />
        </div>
      </Col>
...
aziende importanti.</p>
  ...
  {/* https://www.instagram.com/ViperHaze/ */}
